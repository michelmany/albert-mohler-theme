...
$test = get_field( 'test' );
$selected_briefing_article = get_field( 'select_briefing_article' );
...
<!--                                <img width="96"-->
<!--                                     src="--><?php //echo get_stylesheet_directory_uri() . '/assets/images/the-briefing.svg'; ?><!--"-->
<!--                                     alt="--><?php //the_title(); ?><!--">-->
                            </div>
                        </a>
                        <div class="details">
                            ...
                            <div class="bottom">
                                ...
                                <a href="<?php echo get_term_link( $the_briefing_id ); ?>"
                                   class="btn archive_btn">The Briefing Archives
                                    <svg width="7" viewBox="0 0 268 468"
                                         fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M34 34L234 234L34 434" stroke="currentColor"
                                              stroke-width="66.6667"
                    ...
                    <div class="book_item">
                        ...
                        <div class="details">
                            ...
                            <p> In Tell Me the Stories of Jesus, pastor and theologian R. Albert Mohler Jr.
                                ...
                                announce
                                the kingdom, communicate both judgment and grace, and call every human
                                heart...</p>
                        </div>
                    </div>
				<?php endwhile ?>
