            ...
            <div class="article_items">
              <?php if ($post_all->have_posts()) : while ($post_all->have_posts()) : $post_all->the_post(); ?>
                <div class="article_item single">
                    <a href="<?php the_permalink(); ?>" class="image">
                        <img src="<?php  echo '' . get_bloginfo( 'stylesheet_directory' ).'/assets/images/image.png'; ?>" alt=" <?php the_title(); ?> ">
                    </a>
                    ...
                    <div class="details">
                        ...
                        <p><?php echo mb_substr(wp_strip_all_tags(get_the_content()), 0, 150, 'UTF-8'); ?>...</p>
                        <h4 class="date"><?php echo get_the_date( 'M d, Y' ); ?></h4>
                    </div>
                </div>
                <?php endwhile ?>
